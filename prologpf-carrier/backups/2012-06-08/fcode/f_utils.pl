...
%
% 2. Define the 'def_funs' global listing the defined function names as atoms.
%     This helps the functions->relations conversion step in pf2pl.pl
%
% 3. Defines a library of 'functions' (i.e. Prolog procedures that result from
