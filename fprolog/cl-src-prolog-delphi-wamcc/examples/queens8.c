...
label(3)
      ...
      put_y_value(2,6)
      put_y_value(1,7)
      call(Pred_Name(X246F72635F345F6E6F74746872656174656E6564,8),0,5,"$orc_4_notthreatened",8)          /* begin sub 5 */
      put_y_variable(6,0)
      put_y_value(5,1)
...
label(5)
      ...
      put_y_variable(5,0)
      put_y_value(4,1)
      call(Pred_Name(X6F5F6E657874,2),0,7,"o_next",2)          /* begin sub 7 */
      put_y_unsafe_value(5,0)
      put_y_value(4,1)
      put_y_value(3,2)
      put_y_value(2,3)
