...
#include "queens10_cut.h"
#include "queens10_cut.usr"
...
Begin_Init_Tables(queens10_cut)
...
Begin_Exec_Directives(queens10_cut)
...

{
 ...
 Init_Tables_Of_Module(queens10_cut)

 Exec_Directives_Of_Module(Builtin)
 Exec_Directives_Of_Module(o_utils)
 Exec_Directives_Of_Module(queens10_cut)
