...
#include "queens8_cut.h"
#include "queens8_cut.usr"
...
label(2)
      ...
      unify_x_value(1)
      put_y_variable(6,1)
      call(Pred_Name(X2466756E5F2B,2),0,1,"$fun_+",2)          /* begin sub 1 */
      math_load_y_value(6,0)
      get_y_value(2,0)
      put_y_value(1,0)
      put_y_value(5,1)
      call(Pred_Name(X736E696E74,2),1,2,"snint",2)          /* begin sub 2 */
      put_y_value(4,0)
      put_y_value(3,1)
      put_y_value(2,2)
      put_y_value(1,3)
      call(Pred_Name(X6E6F74746872656174656E6564,4),1,3,"notthreatened",4)          /* begin sub 3 */
      put_y_value(2,0)
      put_y_value(1,1)
      put_y_value(0,2)
      deallocate
...
label(1)
      ...
      unify_x_value(2)
      put_y_variable(1,1)
      call(Pred_Name(X2466756E5F2D,2),0,1,"$fun_-",2)          /* begin sub 1 */
...
Begin_Private_Pred
      ...
      unify_x_value(1)
      put_y_variable(9,1)
      call(Pred_Name(X2466756E5F2D,2),0,2,"$fun_-",2)          /* begin sub 2 */
      ...
      unify_x_value(1)
      put_y_variable(5,1)
      call(Pred_Name(X2466756E5F2B,2),0,3,"$fun_+",2)          /* begin sub 3 */
      math_load_y_value(5,0)
      get_y_variable(1,0)
      put_list(1)
      unify_y_local_value(3)
      ...
      unify_x_value(1)
      put_y_variable(2,1)
      call(Pred_Name(X2466756E5F2B,2),0,4,"$fun_+",2)          /* begin sub 4 */
...
#define ASCII_PRED "o_query"
#define PRED       X6F5F7175657279
#define ARITY      0
...
label(3)
      ...
      put_y_value(1,4)
      put_y_value(5,5)
      call(Pred_Name(X246F72635F325F736E696E74,6),0,3,"$orc_2_snint",6)          /* begin sub 3 */
      put_y_value(4,0)
      put_y_value(3,1)
      put_y_value(2,2)
      put_y_value(1,3)
      call(Pred_Name(X6E6F74746872656174656E6564,4),1,4,"notthreatened",4)          /* begin sub 4 */
      put_y_value(2,0)
      put_y_value(1,1)
      put_y_value(0,2)
      deallocate
...
#define ASCII_PRED "$orc_0_o_query"
#define PRED       X246F72635F305F6F5F7175657279
#define ARITY      4
...
Begin_Init_Tables(queens8_cut)
 ...
 Define_Atom(X6F5F7175657279,"o_query")
 ...
 Define_Atom(X246F72635F305F6F5F7175657279,"$orc_0_o_query")
 ...
 Define_Pred(X6F5F7175657279,0,0)
 ...
 Define_Pred(X246F72635F305F6F5F7175657279,4,1)
...
Begin_Exec_Directives(queens8_cut)
...

{
 ...
 Init_Tables_Of_Module(f_utils)
 Init_Tables_Of_Module(o_utils)
 Init_Tables_Of_Module(queens8_cut)

 Exec_Directives_Of_Module(Builtin)
 Exec_Directives_Of_Module(f_utils)
 Exec_Directives_Of_Module(o_utils)
 Exec_Directives_Of_Module(queens8_cut)
