...
This section gives an overview of the issues surrounding the meta-logical \textit{cut}
...
Prior work on implementations of Prolog with the Delphi principle
