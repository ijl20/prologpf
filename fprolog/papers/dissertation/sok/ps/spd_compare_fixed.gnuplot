...
plot "spd_compare.data" using 1:7 title "SOK fixed, full orcs" with linespoints, \
     "spd_compare.data" using 1:5 title "SOK fixed, orcs to ports" with linespoints, \
     "spd_compare.data" using 1:3 title "SOK fixed, no orc partitioning" with linespoints, \
